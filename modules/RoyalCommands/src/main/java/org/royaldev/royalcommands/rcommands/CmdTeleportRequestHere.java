...
@ReflectCommand
public class CmdTeleportRequestHere extends BaseCommand {

    public CmdTeleportRequestHere(final RoyalCommands instance, final String name) {
    ...
    public boolean runCommand(CommandSender cs, Command cmd, String label, String[] args) {
        ...
        TeleportRequest.send(p, t, TeleportType.HERE);
        return true;
    }
}
