...
public abstract class BaseHomeCommand extends TabCommand {
    ...
    protected BaseHomeCommand(RoyalCommands instance, String name, boolean checkPermissions, Short[] cts) {
        super(instance, name, checkPermissions, cts);
    }

    protected abstract boolean continueCommand(final Player p, final Command cmd, final String label, final String[] eargs, final CommandArguments ca, final Home home);
    ...
    protected boolean runCommand(final CommandSender cs, final Command cmd, final String label, final String[] eargs, final CommandArguments ca) {
        ...
        return this.continueCommand(p, cmd, label, eargs, ca, home);
    }
}
