            ...
            if (args.length == 1) {
                ...
                if (conds.toLowerCase().trim().startsWith("sun")) {
                    ...
                    cs.sendMessage(ChatColor.BLUE + "Set weather to "
                            + ChatColor.GRAY + "sun" + ChatColor.BLUE + " in "
                            + ChatColor.GRAY + world.getName() + ChatColor.BLUE
                            + ".");
                    return true;
                    ...
                    world.setThundering(false);
                    cs.sendMessage(ChatColor.BLUE + "Set weather to "
                            + ChatColor.GRAY + "rain" + ChatColor.BLUE + " in "
                            + ChatColor.GRAY + world.getName() + ChatColor.BLUE
                            + ".");
                    return true;
                ...
                if (conds.toLowerCase().trim().startsWith("sun")) {
                    ...
                    cs.sendMessage(ChatColor.RED + "Invalid condition!");
                    return true;
                }
            }
        }
